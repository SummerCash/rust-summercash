...
pub fn num_finks_per_smc() -> BigUint {
    return BigUint::from_str("1000000000000000000")?; // Return number of finks per SMC
}
...
mod tests {
    ...
    fn test_num_finks_per_smc() {
        assert_eq!(
            num_finks_per_smc(),
            BigUint::from_str("1000000000000000000")?
    ...
    fn test_convert_smc_to_finks() {
        assert_eq!(
            convert_smc_to_finks(BigRational::from_str("1/1")?),
            num_finks_per_smc()
